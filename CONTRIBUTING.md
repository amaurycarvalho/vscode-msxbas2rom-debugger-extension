# Contributing to VSCode Debugger Extension for MSXBAS2ROM
...
You don’t need to be a developer to help improve this project! Here are some valuable ways you can contribute:

- **Report bugs or request features** by creating an [Issue](https://github.com/amaurycarvalho/vscode-msxbas2rom-debugger-extension/issues);  
...
- **Improve the documentation** by editing or adding pages in the [Wiki](https://github.com/amaurycarvalho/vscode-msxbas2rom-debugger-extension/wiki);
...
- PRs should be linked to an existing [issue](https://github.com/amaurycarvalho/vscode-msxbas2rom-debugger-extension/issues) (or include a clear explanation of the change);
- Code should follow the project’s style guidelines and be tested before submission;
- PRs will be reviewed before merging into the `main` branch.
...
1. Go to the original repo:
   [https://github.com/amaurycarvalho/vscode-msxbas2rom-debugger-extension](https://github.com/amaurycarvalho/vscode-msxbas2rom-debugger-extension)
...
```bash
git clone https://github.com/YOUR_GITHUB_ACCOUNT/vscode-msxbas2rom-debugger-extension.git
cd vscode-msxbas2rom-debugger-extension
```
...
Then go to your GitHub fork repository page and open a **Pull Request** to the `main` branch of the original project.
...
- Open a [Discussion](https://github.com/amaurycarvalho/vscode-msxbas2rom-debugger-extension/discussions);
- Contact me through GitHub Issues.

---

Let’s make this **VSCode Debugger Extension for MSXBAS2ROM** better, together! 🚀
