...
Defines the format and conventions for the project's CHANGELOG.md file, ensuring it follows the Keep a Changelog standard for consistency and readability.
